                            ...
                            <div class="tab-pane fade show active" id="commentsTab1" role="tabpanel">
                                <div class="list-group list-lg-group list-group-flush">
                                  ...
                                  <a class="list-group-item list-group-item-action" href="#">
                                        <div class="media">
                                            <img class="u-avatar rounded-circle mr-3" src="{{ asset('img/avatars/img1.jpg') }}" alt="Image description">
                                  ...
                                  <a class="list-group-item list-group-item-action" href="#">
                                        <div class="media">
                                            <img class="u-avatar rounded-circle mr-3" src="{{ asset('img/avatars/img2.jpg') }}" alt="Image description">
                                  ...
                                  <a class="list-group-item list-group-item-action" href="#">
                                        <div class="media">
                                            <img class="u-avatar rounded-circle mr-3" src="{{ asset('img/avatars/img3.jpg') }}" alt="Image description">
                                  ...
                                  <a class="list-group-item list-group-item-action" href="#">
                                        <div class="media">
                                            <img class="u-avatar rounded-circle mr-3" src="{{ asset('img/avatars/user-unknown.jpg') }}" alt="Image description">
                                  ...
                                  <a class="list-group-item list-group-item-action" href="#">
                                        <div class="media">
                                            <img class="u-avatar rounded-circle mr-3" src="{{ asset('img/avatars/img4.jpg') }}" alt="Image description">
