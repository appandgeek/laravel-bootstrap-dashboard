                        ...
                        <div class="row">
                            ...
                            <div class="col-4 px-2 mb-2">
                                <a class="u-apps d-flex flex-column rounded" href="#!">
                                    <img class="img-fluid u-avatar--xs mx-auto mb-2" src="{{ asset('img/brands-sm/img1.png') }}" alt="">
                            ...
                            <div class="col-4 px-2 mb-2">
                                <a class="u-apps d-flex flex-column rounded" href="#!">
                                    <img class="img-fluid u-avatar--xs mx-auto mb-2" src="{{ asset('img/brands-sm/img2.png') }}" alt="">
                            ...
                            <div class="col-4 px-2 mb-2">
                                <a class="u-apps d-flex flex-column rounded" href="#!">
                                    <img class="img-fluid u-avatar--xs mx-auto mb-2" src="{{ asset('img/brands-sm/img3.png') }}" alt="">
                            ...
                            <div class="col-4 px-2">
                                <a class="u-apps d-flex flex-column rounded" href="#!">
                                    <img class="img-fluid u-avatar--xs mx-auto mb-2" src="{{ asset('img/brands-sm/img5.png') }}" alt="">
                            ...
                            <div class="col-4 px-2">
                                <a class="u-apps d-flex flex-column rounded" href="#!">
                                    <img class="img-fluid u-avatar--xs mx-auto mb-2" src="{{ asset('img/brands-sm/img4.png') }}" alt="">
                            ...
                            <div class="col-4 px-2">
                                <a class="u-apps d-flex flex-column rounded" href="#!">
                                    <img class="img-fluid u-avatar--xs mx-auto mb-2" src="{{ asset('img/brands-sm/img6.png') }}" alt="">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            <li class="mb-4">
                                <a class="d-flex align-items-center link-dark" href="{{ url('/profile') }}">
                            ...
                            <li>
                                <a class="d-flex align-items-center link-dark" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                   
                                    <span class="h3 mb-0"><i class="far fa-share-square text-muted mr-3"></i></span> {{ __('Logout') }}
                                </a>
