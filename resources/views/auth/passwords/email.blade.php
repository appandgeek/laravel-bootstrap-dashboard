            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center bg-white mnh-100vh">
                ...
                <div class="u-login-form">
                    <form class="mb-3" method="POST" action="{{ route('password.email') }}">
                        ...
                        <p class="small">Enter the email address you used to register. We will send you an email to reset your password. If you do not receive an email, please check your spam folder as well.</p>
                        @if (session('status'))
                    ...
                    <p class="small text-muted">
                        &larr;  <a href="{{ url('login') }}">Back to login</a>
                    </p>
                </div>
